...
from curvatureLCDM import *		 #Modelo LCDM y curvatura.
from fibradosCosmology import *		 #Modelo para haces fibrados metrica g_3 grupo SU(2)

#Like modules
from BAOLikelihoods import *
from SimpleCMB import *
from CompressedSNLikelihood import *
from CompressedHDLikelihood import * #Cosmic chronometers
...
model_list="LCDOM, LCDMasslessnu, nuLCDM, NeffLCDM, noradLCDM, nuoLCDM, nuwLCDM, oLCDM, wCDM, waCDM, owCDM,"\
           ...
           "EarlyDE, EarlyDE_rd_DE, SlowRDE, fibrados"
...
data_list="BBAO, GBAO, GBAO_no6dF, CMASS, LBAO, LaBAO, LxBAO, MGS, Planck, WMAP, PlRd, WRd, PlDa, PlRdx10,"\
          "CMBW, SN, SNx10, UnionSN, RiessH0, 6dFGS, HD"
