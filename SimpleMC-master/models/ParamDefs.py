...
#Parametros para la metrica g_3 grupo SU(2) para los haces fibrados.
b_par = Parameter("b", 0.5, 0.1, (0.0,1.0),"b")
bdot_par = Parameter("bdot", 0.5, 0.1, (0.0,0.1),"\dot{b}")
bddot_par = Parameter("bddot", 0.5, 0.1, (0.0,0.1),"\ddot{b}")
adot_par = Parameter("adot", 0.5, 0.1, (0.0,0.1), "\dot{a}")
